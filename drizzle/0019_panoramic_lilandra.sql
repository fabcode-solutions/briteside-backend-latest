...
--> statement-breakpoint
ALTER TABLE "story_polls" DROP CONSTRAINT "story_polls_story_id_unique";--> statement-breakpoint
ALTER TABLE "posts" ADD COLUMN "aspect_ratios" json DEFAULT '[]'::json;--> statement-breakpoint
