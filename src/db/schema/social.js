...
export const socialProfiles = pgTable(
  'social_profiles',
  {
    ...
    profileSongTrackId: varchar('profile_song_track_id', { length: 50 }),
    profileSongTrackName: varchar('profile_song_track_name', { length: 300 }),
    profileSongArtistName: varchar('profile_song_artist_name', { length: 300 }),
    profileSongArtworkUrl: text('profile_song_artwork_url'),
    profileSongPreviewUrl: text('profile_song_preview_url'),
    profileSongAppleMusicUrl: text('profile_song_apple_music_url'),
    createdAt: timestamp('created_at', { withTimezone: true }).notNull().defaultNow(),
